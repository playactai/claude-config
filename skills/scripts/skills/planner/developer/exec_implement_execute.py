    ...
    if step == 1:
        ...
        return {
            ...
            "actions": [
                ...
                "     - Acceptance criteria",
                "     - Approved code_changes[].diff for the milestone (from plan.json):",
                "       the QR-approved diffs are the implementation source, not just the",
                "       acceptance criteria. Apply them; re-anchor only on genuine drift.",
        ...
        return {
            ...
            "actions": [
                ...
                "  - CODE_CHANGES: the milestone's QR-approved code_changes[].diff from",
                "    plan.json -- apply these as the implementation source (not a re-derivation",
                "    from acceptance criteria); re-anchor only where the file genuinely drifted.",
            ],
