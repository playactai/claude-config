    ...
    if step == 1:
        ...
        return {
            ...
            "actions": [
                ...
                "  3. Write each diff to a temp file with the Write tool",
                "  4. Register changes via --diff-file (or batch from stdin)",
                "",
                ...
                "  ]",
                "",
                "WHY files/stdin, not inline $'...': real diffs contain apostrophes and",
                "backslashes that break shell quoting and silently corrupt the stored hunk.",
                "",
        ...
        return {
            ...
            "actions": [
                ...
                "=" * 60,
                "",
                "For EACH code_intent, register the diff via a file (never inline shell):",
                "",
                "WORKFLOW:",
                ...
                "",
                "DIFF EXAMPLE:",
                "  # 1. Write /tmp/CI-M-001-001.diff (Write tool) with the unified diff:",
                "     --- a/path/to/file.py",
                "     +++ b/path/to/file.py",
        ...
        return {
            ...
            "actions": [
                ...
                "  - All decision_refs point to existing decisions",
                "",
                "NOTE: validate does NOT open target files. Whether context lines match",
                "real file content is YOUR responsibility -- verify it yourself (checklist",
                "below); the CLI cannot and does not check it.",
                "",
