...
class PlanDocsVerify(VerifyBase):
    ...
    def get_verification_guidance(self, item: dict, state_dir: str) -> list[str]:
        ...
        if scope == "*":
            ...
            guidance.extend(
                [
                    ...
                    "",
                    "  Verify this decision is referenced in at least one doc_diff:",
            ...
            guidance.extend(
                [
                    ...
                    "",
                    "  Extract milestone code_changes with doc_diff status:",
        ...
        elif "decision" in check.lower() and (
            "coverage" in check.lower() or "uncovered" in check.lower()
        ):
            guidance.extend(
                [
