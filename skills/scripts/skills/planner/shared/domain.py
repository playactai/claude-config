...
class IssueCategory(Enum):
    ...
    MISSED_SIMPLIFICATION = "MISSED_SIMPLIFICATION"
    FILE_SIZE_EXPLOSION = "FILE_SIZE_EXPLOSION"
    SPAGHETTI_CONDITIONAL = "SPAGHETTI_CONDITIONAL"
    THIN_ABSTRACTION = "THIN_ABSTRACTION"
    BOUNDARY_TYPE_EROSION = "BOUNDARY_TYPE_EROSION"
    CANONICAL_DUPLICATION = "CANONICAL_DUPLICATION"
    LAYER_LEAK = "LAYER_LEAK"
    NON_ATOMIC_ORCHESTRATION = "NON_ATOMIC_ORCHESTRATION"
...
CATEGORY_SEVERITY: dict[IssueCategory, Severity] = {
    ...
    # STRUCTURAL SIMPLIFICATION -> SHOULD. Keep these SHOULD: the subjective ones
    # (esp. MISSED_SIMPLIFICATION) rely on SHOULD de-escalation in
    # get_blocking_severities to avoid non-terminating QR loops.
    IssueCategory.MISSED_SIMPLIFICATION: Severity.SHOULD,
    IssueCategory.FILE_SIZE_EXPLOSION: Severity.SHOULD,
    IssueCategory.SPAGHETTI_CONDITIONAL: Severity.SHOULD,
    IssueCategory.THIN_ABSTRACTION: Severity.SHOULD,
    IssueCategory.BOUNDARY_TYPE_EROSION: Severity.SHOULD,
    IssueCategory.CANONICAL_DUPLICATION: Severity.SHOULD,
    IssueCategory.LAYER_LEAK: Severity.SHOULD,
    IssueCategory.NON_ATOMIC_ORCHESTRATION: Severity.SHOULD,
    # COSMETIC -> COULD
