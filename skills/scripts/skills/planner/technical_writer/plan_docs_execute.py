    ...
    if step == 1:
        ...
        actions.extend(
            [
                ...
                "  " + pin_cwd("uv run python -m skills.planner.cli.plan --state-dir $STATE_DIR set-doc-diff \\"),
                "    --change CC-M-001-001 --version 1 --content-file /tmp/doc.diff",
                "",
                "  # Create documentation-only change (README, etc.):",
                "  " + pin_cwd("uv run python -m skills.planner.cli.plan --state-dir $STATE_DIR create-doc-change \\"),
        ...
        return {
            ...
            "actions": [
                ...
                f"  {pin_cwd('uv run python -m skills.planner.cli.plan list-decisions')}",
                "",
        ...
        return {
            ...
            "actions": [
                ...
                "",
                "Run validation:",
                f"  {pin_cwd(f'uv run python -m skills.planner.cli.plan validate --phase plan-docs --state-dir {state_dir}')}",
                "",
