    ...
    if step == 1:
        ...
        actions.extend(
            [
                ...
                "  uv run python -m skills.planner.cli.plan --state-dir $STATE_DIR set-doc-diff \\",
                "    --change CC-M-001-001 --version 1 --content-file /tmp/doc.diff",
                "",
                "  # Create documentation-only change (README, etc.):",
                "  uv run python -m skills.planner.cli.plan --state-dir $STATE_DIR create-doc-change \\",
        ...
        return {
            ...
            "actions": [
                ...
                "  uv run python -m skills.planner.cli.plan list-decisions",
                "",
        ...
        return {
            ...
            "actions": [
                ...
                "",
                "Run validation:",
                f"  uv run python -m skills.planner.cli.plan validate --phase plan-docs --state-dir {state_dir}",
                "",
